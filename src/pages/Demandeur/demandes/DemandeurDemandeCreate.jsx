...
export default function DemandeurDemandeCreate() {
  ...
  }, [form, current, invites, selectedNotifyOrgIds, paymentMethod, paymentCompleted, t]);
            ...
            >
              ...
              <div style={{ display: current === 0 ? "block" : "none" }}>
                ...
                <Row gutter={16}>
                  <Col xs={24} md={8}>
                    <Form.Item
                      label={<span style={{ fontFamily: "Arial, sans-serif", fontWeight: "bold" }}>{t("demandeurDemandeCreate.fields.dateOfBirth")}</span>}
                      name="dob"
                  ...
                  <Col xs={24} md={8}>
                    <Form.Item
                      label={<span style={{ fontFamily: "Arial, sans-serif", fontWeight: "bold" }}>{t("demandeurDemandeCreate.fields.countryOfCitizenship")}</span>}
                      name="citizenship"
                    >
                      <Select
                        allowClear
                  ...
                  <Col xs={24} md={8}>
                    <Form.Item
                      label={<span style={{ fontFamily: "Arial, sans-serif", fontWeight: "bold" }}>{t("demandeurDemandeCreate.fields.passportNumber")}</span>}
                      name="passport"
                    >
                      <Input size="large" />
                    </Form.Item>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <Card size="small" title={t("demandeurDemandeCreate.summary.academic")} style={{ borderRadius: 8 }}>
        <Item
          ...
          value={[v.serie, v.niveau, v.mention].filter(Boolean).join(" / ") || "—"}
        />
        <Item
        ...
        />
        <Item
          label={t("demandeurDemandeCreate.summary.school")}
          value={v.secondarySchoolName}
        />
        <Item
          label={t("demandeurDemandeCreate.summary.country")}
          value={v.countryOfSchool}
        />
        <Item
          label={t("demandeurDemandeCreate.summary.diploma")}
          value={v.graduationDate ? dayjs(v.graduationDate).format("DD/MM/YYYY") : "—"}
        />
      </Card>
      ...
      <Card size="small" title={t("demandeurDemandeCreate.summary.target")} style={{ borderRadius: 8 }}>
        <Item
          label={t("demandeurDemandeCreate.summary.targetOrg")}
          value={getOrgName(v.targetOrgId)}
        />
        <Item
          label={t("demandeurDemandeCreate.summary.translationOrg")}
          value={getOrgName(v.assignedOrgId)}
        />
        <Item
          label={t("demandeurDemandeCreate.summary.period")}
          value={v.periode || "—"}
        />
        <Item
          label={t("demandeurDemandeCreate.summary.year")}
          value={v.year || "—"}
        />
        <Item
          label={t("demandeurDemandeCreate.summary.intendedMajor")}
